...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: '스트릭(연속 읽기)은 어떻게 쌓이나요?',
    answer:
      '매일 "읽었어요!"를 눌러 오늘 목표를 채우면 스트릭이 1씩 올라가요. 유예 기간(최대 2일) 안에는 하루 이틀 건너뛰어도 스트릭이 끊기지 않아요.',
  },
  {
  ...
  {
    question: '회독은 뭔가요?',
    answer: '66권을 모두 완독하면 자동으로 처음 책으로 돌아가고 회독수가 1 올라가요. 스트릭은 그대로 이어져요.',
  },
  {
