...
const INTRO_SLIDES: IntroSlide[] = [
  ...
  {
    emoji: '🔥',
    title: '매일 읽으면 스트릭이 쌓여요',
    description: '오늘의 목표를 채우면 연속 기록(스트릭)이 올라가요. 하루 이틀 못 읽어도 유예가 있어서 바로 끊기지 않아요.',
  },
  {
    emoji: '🏆',
    title: '함께 읽는 사람들과 랭킹으로 겨뤄요',
    description: '랭킹에서 회독수와 진행률을 비교하고, 같은 책을 읽는 사람에게 화이팅을 보낼 수 있어요.',
  },
  {
    emoji: '🔔',
